...
description: >-
  ...
  peer acknowledgment before system deployment. Software-product team implements
  after gate. Use when the user asks for multi-agent review, expert council,
  agent debate, peer sign-off, architectural decisions, scoring/risk changes, or
  says COUNCIL, DEBATE, or PEER REVIEW for this repo. Pair with BUILD for
  implementation.
---
