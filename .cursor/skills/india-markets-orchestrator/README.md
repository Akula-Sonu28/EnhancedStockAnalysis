...
COUNCIL <topic>                                  → five-agent-council (loads india-markets bridge)
```
...
Each desk skill has a **Five-Agent Council** escalation section for code-change handoff.
...
- `five-agent-council` — code/architecture decisions (see `product-teams-bridge.md`)
...
- `team-roster.md` — routing + council↔desk map
- `market-basics.md` — NSE context for this project

Council bridge: `.cursor/skills/five-agent-council/references/product-teams-bridge.md`
