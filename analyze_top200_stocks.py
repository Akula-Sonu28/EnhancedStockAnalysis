...
class Top200StockAnalyzer:
    ...
    def __init__(self, max_workers=5, csv_file=None):
    ...
    def analyze_single_stock(self, symbol):
        ...
        try:
            ...
            stock_data.update({
                ...
                'OverallScore': (fund_score * 0.5) + (enhanced_score * 0.3) + (legacy_score * 0.2),
    ...
    def generate_comprehensive_report(self):
        ...
        try:
            ...
            # Use ExcelReportGenerator to generate the report
...
def export_default_stocks_to_csv(output_path="default_stock_list.csv"):
    ...
    try:
        ...
        dummy = Top200StockAnalyzer(max_workers=1)
...
def main():
    ...
    # Initialize analyzer
    analyzer = Top200StockAnalyzer(max_workers=args.workers, csv_file=args.csv)  # User-specified worker count and CSV file
